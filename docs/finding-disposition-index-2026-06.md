...
| **W2** | Signed `registration_date`, tier attestation, JCS, offline root, expiry | FDI-CRY-001/002, FDI-ID-004 | — | — | JCS has no owning area (C9); v1-tarball verifier story during re-sign window unstated | — |
