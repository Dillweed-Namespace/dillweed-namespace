...
## Current Task: Resolver refresh jitter + exponential backoff
## Blocked On: nothing
## Next Step: Add randomized jitter to the registry refresh interval and exponential backoff on sync failure in the resolver refresh loop (resolver review S1/S7, v2 design §2.3 step 5)
